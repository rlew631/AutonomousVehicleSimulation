...
This file can be run with: 
    ...
    where EXP_CONFIG is the name of the experiment configuration file
OR:
...
def parse_args(args):
    ...
    parser.add_argument( # I added this
        '--no_render',
        action='store_true',
...
def train_rllib(submodule, flags):
    ...
    exp_config = {
        ...
        "checkpoint_freq": 1, # doesn't seem like there's errors but keep it like this for now
